...
namespace KitOnline
{
    public enum CheckErrorCodeEnum
    {
        ...
        [Description("Ошибка ФН")] FiscalStorageError = 3,

        [Description("Ошибка KC")] CryptoprocessorError = 4,

        [Description("Закончен срок эксплуатации ФН")]
        FiscalStorageLifeTime = 5,

        [Description("Архив ФН переполнен")] ArchiveIsFull = 6,
        ...
        [Description("Неизвестная команда")] UnknownCommand = 18,
        ...
        [Description("Нет связи с ФН")] FiscalStorageNoConnect = 21,
        ...
        [Description("Аппаратный сбой ККТ")] HardwareError = 26,

        [Description(
            "Неверно указан признак расчета, возможные значения: приход, расход, возврат прихода, возврат расхода")]
        ...
        [Description(
            "В чеке не должны присутствовать иные предметы расчета помимо предмета расчета с признаком способа расчета Оплата кредита")]
        ...
        [Description("Нет рабочих ККТ")] NoWorkingCashregisters = 50,
        ...
        [Description("Нет связи с ККТ")] CashregisterNotResponding = 55,
