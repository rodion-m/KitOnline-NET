...
namespace KitOnline.Models
{
    ...
    public class Subject
    {
        ...
        /// </summary>
        /// <example>
        ///     Subject.ListOf(TaxTypeEnum.NoTax, PayAttributeTypeEnum.FullPayment, GoodsAttributeTypeEnum.Commodity, ("Маракуйя",
        ///     25m, 2), ("Сахар", 50m, 0.5m))
        /// </example>
            ...
            params (string name, decimal priceRub, decimal quantity)[] subjects)
        {
            ...
            return subjects.Select(it =>
                new Subject(it.name, it.priceRub, it.quantity, tax, payAttribute, goodsAttribute));
        }
